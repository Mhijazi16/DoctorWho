...
namespace DoctorWho.Db.Migrations
{
    ...
    public partial class FirstMigration : Migration
    {
        ...
        {
            CreateAuthorTable(migrationBuilder);

            CreateCompanionTable(migrationBuilder);

            CreateDoctorTable(migrationBuilder);

            CreateEnemyTable(migrationBuilder);

            CreateEpisodeTable(migrationBuilder);

            CreateEpisodeCompanionTable(migrationBuilder);

            CreateEpisodeEnemyTable(migrationBuilder);
        ...
        private static void CreateEpisodeEnemyTable(MigrationBuilder migrationBuilder)
        {
        ...
        private static void CreateEpisodeCompanionTable(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "tblEpisodeCompanion",
                columns: table => new
        ...
        private static void CreateEpisodeTable(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "tblEpisode",
                columns: table => new
        ...
        private static void CreateEnemyTable(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "tblEnemy",
                columns: table => new
                ...
                constraints: table => { table.PrimaryKey("PK__tblEnemy__911A0BD2AC4B36E9", x => x.EnemyID); });
        }

        private static void CreateDoctorTable(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "tblDoctor",
                columns: table => new
                ...
                constraints: table => { table.PrimaryKey("PK__tblDocto__2DC00EDF6E1BB984", x => x.DoctorID); });
        }

        private static void CreateCompanionTable(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "tblCompanion",
                columns: table => new
                ...
                constraints: table => { table.PrimaryKey("PK__tblCompa__8B53BE8B2BED7BDE", x => x.CompanionID); });
        }

        private static void CreateAuthorTable(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "tblAuthor",
                columns: table => new
                ...
                constraints: table => { table.PrimaryKey("PK__tblAutho__70DAFC14745C864A", x => x.AuthorID); });
        }
